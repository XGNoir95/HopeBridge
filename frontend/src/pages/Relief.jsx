...
import data from "../data.json"; // Import the static data
...
const Relief = () => {
  ...
  // Fetch districts
  useEffect(() => {
    // Commented out the API call for fetching districts
    /*
    ...
    */
    ...
    // Use static data for districts and sort them alphabetically
    const allDistricts = data.divisions
      .flatMap((division) => division.districts) // Flatten the districts array
