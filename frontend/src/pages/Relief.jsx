...
import { ChevronLeft, ChevronRight, AlertTriangle, Network } from "lucide-react";
                ...
                {Array.isArray(resources) && resources.map((resource, index) => (
                  <div key={index} className="p-5">
                    <div className="bg-gray-100 border border-gray-800 p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 text-center">
                      ...
                      <p className="text-gray-600 text-lg">Quantity: <span className="font-medium text-amber-600">{resource.quantity}</span></p>
                ...
                {Array.isArray(donors) && donors.map((donor, index) => (
                  <div key={index} className="p-5">
                    <div className="bg-gray-100 border border-gray-800 p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 text-center">
                      ...
                      <p className="text-gray-600 text-lg font-bold">Blood Type: <span className="font-medium text-amber-600">{donor.blood_group}</span></p>
                      <p className="text-gray-600 text-lg">Contact: {donor.donorPhone}</p>
                      <p className="text-gray-600 text-lg font-semibold">Location: {donor.district}, {donor.division}</p>
