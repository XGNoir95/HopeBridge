...
const DonateBlood = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      else setError("Failed to submit donation. Please try again.");
    } catch (error) {
      ...
      <div className="flex min-h-screen">
        ...
        <div className="hidden lg:flex lg:w-[40%] bg-[#311B08] flex-col items-center justify-center p-8 text-white">
          <div className="text-center space-y-6">
            ...
            <p className="text-2xl opacity-90">Register as a blood donor and help save lives in your community</p>
            <p className="text-xl opacity-75">Your donation can make the difference between life and death.</p>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="flex min-h-screen">
      {/* Left Form Section */}
      <div className="w-full lg:w-[55%] bg-gray-50 flex items-center justify-center p-4 sm:p-6 lg:p-8">
