...
const ReportIncident = () => {
  ...
  const fetchDistricts = (division) => {
    axios
      .get(`/bdapi/v1.2/division/${division}`)
      .then((response) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const formattedTime = formData.event_time
      ...
      <div className="layout-container flex h-full grow flex-col items-center py-10">
        ...
        <div className="w-[780px] max-w-[1024px] py-5 border border-amber-900 rounded-xl shadow-lg bg-white p-8">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col">
            ...
            <label className="text-lg font-bold px-4 pb-2 mt-4">
              Description
            </label>
            <textarea
              name="description"
            ...
            <div className="flex gap-4">
              <select
                name="division"
                className="w-full rounded-xl bg-gray-100 h-14 p-[15px] text-base"
              ...
              <select
                name="district"
                className="w-full rounded-xl bg-gray-100 h-14 p-[15px] text-base disabled:bg-gray-300"
            ...
            <div className="flex px-4 py-5 justify-center">
              <button
                type="submit"
                disabled={loading}
                className="text-white flex w-[220px] h-14 cursor-pointer items-center justify-center rounded-xl bg-gradient-to-r from-amber-900 to-amber-600 text-lg font-bold hover:scale-105 transition-all"
              >
